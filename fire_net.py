...
def detect_from_video():
    ...
    detected_video_path = detector.detectObjectsFromVideo(input_file_path=os.path.join(execution_path, "video_Me.mp4"), frames_per_second=30, output_file_path=os.path.join(execution_path, "video_Me-detected"), minimum_percentage_probability=40, log_progress=True )
